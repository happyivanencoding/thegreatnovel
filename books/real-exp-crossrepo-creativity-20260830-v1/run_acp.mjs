...
const ps = spawn('pwsh.exe',['-NoProfile','-File','C:/Users/jingx/AppData/Roaming/npm/codex-acp.ps1'],{cwd:'C:/dev/tgn-story-mvp-creativity-crossrepo-20260830',env:{...process.env,INITIAL_AGENT_MODE:'read-only'},stdio:['pipe','pipe','inherit']});
...
try{
 const result=await client.connectWith(stream,async(ctx)=>{
  ...
  return await ctx.buildSession('C:/dev/tgn-story-mvp-creativity-crossrepo-20260830').withSession(async(session)=>{
