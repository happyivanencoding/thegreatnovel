...
# EXPERIMENTAL LIVING ACTOR WORLD｜只改变“世界正在发生的大事”的生成姿态
这不是新字段、Agent 或 Story Program。保持上面的全部 World Authority 合同不变。
- `世界正在发生的大事` 的 3—6 件事里，至少 3 件从**具体行动者**开始：他/她/它/这个小群体现在私人地想得到、保住、逃离、证明、报复、追赶或找到什么；下一步已经准备做哪个可见动作；即使未来主角永远不出现，这个动作会实际改变谁/什么地方/哪件东西。
- 行动者可以是强者、少年、怪物、工匠、猎队、小家族、敌对人物，不默认是统治者/机构。至少一条由面子、爱、嫉妒、占有、好奇、仇、舍不得、证明自己等非治理欲望发动。
- 多条大事若会碰撞，优先因为它们争同一个具体人/物/地点、互相追杀、抢先抵达、带走/毁掉某物，而不是因为“各方需要协调资源”。
- 不新增倒计时表、势力 KPI、actor schema 或管理流程。仍用正常段落输出；不要在其它章节机械重复这些字段。
- 世界仍 protagonist-blind：这些人绝不能预先针对未来主角或未来 Power。
