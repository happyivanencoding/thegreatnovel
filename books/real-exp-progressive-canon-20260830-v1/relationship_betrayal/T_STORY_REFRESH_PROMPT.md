...
# 作者粗方向
成熟中文男频关系冲突。保留背叛的真实重量、吸引与怨恨并存；不要用一个秘密把燕迟洗成纯牺牲圣人，也不要让江野自动选择原谅。

# EFFECTIVE WORLD｜Independent Authority
# EFFECTIVE WORLD｜鹤鸣边州
...
江野｜剑阶11；想变强、拿回旧军械库，也想亲口问燕迟为什么。好胜、记仇、对燕迟仍有强烈偏心但绝不愿承认；妹妹的安全会直接改变他的冒险阈值。

# ALREADY-HAPPENED CANON MEMORY
燕迟开门与杀统领为已发生事实；妹妹后来被她救走也为已发生事实；双方尚未完成对质。未知是动机与承诺对象，不是行为本身。

# PREVIOUS STORY PROGRAM｜Only unresolved future obligations survive
下一阶段固定包含公开物证、第一次正面对质、旧军械库争夺和关系重新定价；不要求本阶段解决更大的敌方幕后。

# AUTHOR MYSTERY PLANNING CONTROL｜PLANNING ONLY / NEVER READER CANON
Mystery M-REL-01｜AUTHOR FIXED HIDDEN｜Route: story
Fixed Point: 燕迟主动开门，是因为她判断守门会造成更大的、更加不可控的损失；她也主动接受了必须由自己承担的私人后果，而非向敌方效忠。
Still Open: 她预见的更大损失是否真实、实际避免了什么、她答应承担的后果是什么、承诺对象是谁，以及妹妹是否属于同一因果链，仍未知。
