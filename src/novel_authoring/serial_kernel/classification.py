...
def _payoff_for_drive(drive: NarrativeDrive) -> PayoffChannel:
    mapping = {
        ...
        NarrativeDrive.ABILITY_PROGRESSION: PayoffChannel.NEW_ABILITY,
        NarrativeDrive.BODY_EVOLUTION: PayoffChannel.TRANSFORMATION,
        NarrativeDrive.SEQUENCE_PROGRESSION: PayoffChannel.POWER_BREAKTHROUGH,
        NarrativeDrive.STATUS_PROGRESSION: PayoffChannel.STATUS_RISE,
        ...
        NarrativeDrive.CRAFT_PROFESSION: PayoffChannel.MASTERY,
        NarrativeDrive.STATUS_WEALTH: PayoffChannel.WEALTH_GAIN,
        ...
        NarrativeDrive.BASE_BUILDING: PayoffChannel.STRATEGIC_ADVANTAGE,
