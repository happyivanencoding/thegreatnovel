...
## 世界中的初始位置与生活事实
只来自 LIFE_CONTEXT；写具体出身、家庭、教育、工作/修炼接触与真实发生过的生活事实。**经历是生活上下文，不是人格证明**：不要求每段经历都逐条推出一个人格适应结论，也不从预先决定的人格反向发明恰好证明它的童年。

## 持续牵引与互相竞争的动机
保留 2—4 股会长期进入选择的私人牵引。它们可以是胜负、钱、身体欲望、审美、好奇、享受、面子、亲近、自由、责任、野心、报复、归属或本书自己的东西；允许互相冲突、改变强弱、被关系重排。人物可以在其中某些欲望上明显“过量”，但不要求把全部人生统一成一个单一核心执念。
