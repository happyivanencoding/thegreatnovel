...
- **Public Milestone Ladder = 全社会公开的未来力量承诺。** 精确主尺回答“现在多强”；当前可见范围内少数真正的大阶段还必须回答“跨过去以后，人生里有什么以前绝不可能的事变成可能”。这里只冻结世界通用的公共质变，不知道未来主角是谁。每个真正里程碑至少同时有：①一个**公共新动词**——不是更强/更快/更硬/更久，而是过去做不到、到此阶段通常第一次能做的动作或状态；②一个**社会识别**——别人凭什么知道这种人已经属于另一层；③一个**世界开口**——因此新能进入/承受/接触哪种环境、地图、身份、人物或资源；④一个**少年为什么向往**的具体画面或现实好处。大档名存在时，它应优先成为读者的力量身份，精确数字负责第二层校准，例如“铸脊，炉级41”而不是只剩“炉级41”。不要逐级列能力，不规定固定里程碑数量；连续小级可以只提高基础盘。某个所谓大阶段若目前只有数值放大，就把它视为尚未设计完成的区间名，直到找到真正公共质变；也不要为了填结构复制魂环、能力槽或另造第二套技能系统。
...
- `<大阶段/精确门槛>`｜公共新动词：`过去绝不可能、到此通常第一次能做到什么`｜社会识别：`世界怎样认出/对待这一层的人`｜世界开口：`因此新能进入/承受/接触什么地图、环境、身份、人物或资源`｜少年为什么向往：`一个低阶者能看见、羡慕或渴望的具体画面/现实好处`
