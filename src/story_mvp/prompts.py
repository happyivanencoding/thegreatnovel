...
`## Opening Strategy` 负责把这些事实真正放到可执行位置：若是第一章且读者还没有最低安全/社会/生活坐标，不要只写“从动作切入”，而要明确指定其中 **1 条** Orientation Fact 在第一轮核心冲突前或紧贴首次专属场景名词，用一句/短段旁白完成；若是重要势力/地点第一次挡路，也明确指出在哪个触发动作后回答“它是什么/为什么重要”，随后立即回到现场。不要同时塞 3 条，也不要把 Orientation 拖成开场设定课。
