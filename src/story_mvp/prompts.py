...
PROTAGONIST_BEHAVIOR_SIGNATURE_DIRECTION = """Protagonist Behavior Signature：主角“想要什么”之外，还要尽早知道“他会怎么要”。不要从预设的优秀男主标签库拼人格，也不要默认人格必须值得赞美。重点是：面对同样的诱惑、羞辱、风险、巨大收益、关系压力与力量差时，这个人有哪些稳定而未必最正确的偏爱，会因此做出怎样更像自己的选择。后续 Contestable Choice 没有标准答案时，应由这个行为签名决定取舍，而不是由系统默认的理性、克制、公平或公共利益最大化代理人替他决定。"""

PROTAGONIST_LIFE_ENGINE_DIRECTION = """Protagonist Life Engine：Fantasy Seed 不只回答“这个能力能怎么玩”，还要知道“即使核心优势暂时不能用，什么私人欲望、困境、执念或生活方向仍会牵动这个人继续行动”。主角最强欲望至少区分**眼前目标**与**能力之外仍成立的人生牵引**。人生牵引不是必须一次定义三百万字终身使命：它可以阶段性、尚不成熟、自私、琐碎、矛盾，也可以被关系与经历改写；不要求宏大、悲惨、道德高尚或来自家庭/创伤。不要把“让核心能力更强、找到更多适合能力的对象、把玩法做得更大”换个说法冒充人生牵引，也不要因为核心幻想隐含某种社会不对称，就自动把主角的人生提纯成公共改革、制度理想或替所有人解决问题。能力应当成为这个人走人生的一种力量，而不是反过来把人生变成能力使用说明。"""
