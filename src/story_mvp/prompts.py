...
长期线程必须服从已有 Authority：可以推进问题，不得替 AUTHOR OPEN 的谜团擅自给答案，也不得为了制造 Book Mutation 新造奖励、离屏战果、人物过去或未来世界事实。Recurring Rival / 旧人物若缺席合理，可以通过可靠消息、利益变化、别人采取的新行动、遗产/缺口或其留下的后果继续生效；关系/人物是否仍活着的判断是：删掉这段历史以后，主角当前选择、代价、时间窗口或可用行动会不会不同。目标是让不同 Horizon 的 Local Story 各自完整，同时让它们不可逆地改写同一个主角、关系网、社会位置和长期问题。"""
