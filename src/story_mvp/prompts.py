...
连续动作、感知和判断组成自然连贯的句段。已经发生的事由后果继续往下带，不再另起短句替它裁断或升华。不要把普通说明整理成整齐排比、重复句首或三项同构短句；各句写它真正需要承载的内容，长短随内容变化。
...
- **一次说话承载一个完整意思。** 同一人物正在说明条件、表达态度或追问理由，且没有被现场真正打断时，让他把这个意思说完，再由对方回应；不要借另一人的连续短问句把一段意思切成多轮。简单应答、重复确认和次要交谈可以用叙述带过，保留真正有态度、关系或选择分量的原话。急促打断来自具体危险与人物冲突，平静交谈不持续用短句抢答。
