...
长期线程必须服从已有 Authority：可以推进问题，不得替 AUTHOR OPEN 的谜团擅自给答案，也不得为了制造 Book Mutation 新造奖励、离屏战果、人物过去或未来世界事实。Recurring Rival / 旧人物若缺席合理，可以通过可靠消息、利益变化、别人采取的新行动、遗产/缺口或其留下的后果继续生效；关系/人物是否仍活着的判断是：删掉这段历史以后，当前选择、代价、时间窗口或可用行动会不会不同。

**Longitudinal Cast ≠ Important NPC List。** 少数真正重要的人物除了“怎样影响主角”，还应拥有自己仍在运动的欲望、未完人生与已经启动的下一步：如果主角此刻消失，他仍会因为已有目标、承诺、损失、限制或关系继续做什么。只有这种因果已经在 Authority / Canon / 当前 Story 中成立时才允许 offscreen-forward；不得为显得人物丰富，事后补写一整段未发生的离屏奇遇、重大获得、联盟或人生转折。人物回流时优先让读者先看见“离开后的他才会做出的新动作/新处境”，再补最低充分解释；讲完的人允许真正结束，不给所有 NPC 长篇支线。

**人物关系不必全部经过主角；Convergence ≠ Recall。** 如果两个重要人物之间已经存在会改变行动的亲缘、爱情、师徒、竞争、利益、债、背叛、效忠或共同历史，可以让这条关系继续改变双方选择；没有真实因果就不画全员关系网。多条成熟人物线只有在各自正在追逐的同一人、物、地点、身份、时间窗口或决定形成共同因果铰链时才汇流；高潮不能只是把旧人物叫回来站队。配角可以成长、变强、恋爱、失败、改阵营、拿走主角错失的奖励甚至阶段性强于主角，但 Supporting Cast Richness 不授权给普通配角复制主角递归增长的 Advantage Stack。目标是让不同 Horizon 的 Local Story 各自完整，同时让它们不可逆地改写同一个主角、人物群关系、社会位置和长期问题。"""
...
## 不可替代的人与关系
写少量具体人物，不写人物名单。每个人先有自己的欲望；对真正可能跨阶段继续有分量的人，再补清楚**他自己的未完人生与已启动行动**：现在最想得到/避免什么、哪件自己的事还没结、如果主角此刻消失他下一步仍会因已有因果做什么。再说明为什么“同等有用的另一个人”不能替代，以及他与主角的关系怎样改变风险、去留、时间、暴露或机会牺牲。**主角只是关系网中的一条边**：若两个重要人物之间已经存在会改变行动的亲缘、爱情、师徒、竞争、利益、债、背叛、效忠或共同历史，保留最少必要的一条人物—人物因果；没有就不补，不为群像画全员关系网。允许人物离屏、休眠、结束或只留下 afterlife；回流必须承接离场前已经存在的目标/承诺/损失/限制，不得事后凭空补一段关键人生。允许爱情、身体吸引、友情、竞争、依赖、嫉妒、效忠、背叛和敌意，不统一成安全合作。若 Approved World 已经给某个具名人物明确的公开描述（例如老器师、年轻少主、军府统领等），这里必须原样继承其身份/年龄资历含义，不为角色化方便静默改年轻、改性别或换职位。
