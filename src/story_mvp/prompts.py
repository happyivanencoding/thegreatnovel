...
## 全书成长与核心幻想兑现脊柱
只写真正改变主角本人能力结构与行动方式的**少数、够重的可观察质变**，分布在早期、中期与高阶的自然故事里，不规定固定次数。大结构质变之间不等于“力量没有新鲜感”：应持续让已有力量语法长出新的招式、身体表现、兵器/奇物、敌人能力、环境玩法、越级对象与复合战法。全书不能只有开局 Core Asymmetry 一路放大：长期应让**新的 Power Asymmetry 加入**，并让旧优势与新优势产生可复述的**复合效应**——不是两个能力分别使用，而是组合后出现任一单项都做不到的新玩法。每次都用具体事实写清“以前做不到什么 → 现在能做什么 / 能打谁 / 能去哪里 / 哪两个优势怎样一起产生新结果”；拒绝用“行动空间扩大”“能力复利”“层级提升”等后台词替代故事事实。这里是全书纵向要求，不是每阶段新增能力税；某些大型阶段仍可以完全没有 Power Delta。
