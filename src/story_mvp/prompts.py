...
PROTAGONIST_LIFE_ENGINE_DIRECTION = """Protagonist Life Engine：Fantasy Seed 不只回答“这个能力能怎么玩”，还要回答“即使核心优势暂时不能用，这个人的人生里还有什么会让他继续主动往前”。主角最强欲望至少区分**眼前目标**与**能力之外仍成立的人生牵引**。人生牵引不要求宏大、悲惨、道德高尚、来自家庭/创伤或永远不变；它只需要真实到足以在最初问题解决后继续改变主角的选择与方向。不能把“让核心能力更强、找到更多适合能力的对象、把玩法做得更大”换个说法冒充人生牵引。能力应当成为这个人走人生的一种力量，而不是反过来把人生变成能力使用说明。"""
...
生成 3—5 个真正不同的候选。不评分、不排名、不自动选择。整个候选集要追求**故事物种差异**，而不只是机制换皮：综合看 Fantasy（最想拥有什么）、Gameplay（主角反复做什么）、Life Engine（为什么活、为什么继续往前）与 Human Gravity（什么样的人与关系会持续改变他）。不要求四项逐条打勾，也不要求每本都极端，但如果能力不同而人生牵引、重大选择伦理、关系重心和情绪满足高度同构，仍视为候选坍缩。先写最强欲望与占有感，再看它能否长篇；不要为了“安全多样”给每个候选平均分配同一套亲情、创伤、旧秘密或优秀人格。
