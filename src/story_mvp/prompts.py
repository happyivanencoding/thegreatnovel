...
LONGITUDINAL_THREAD_ADVANCE_DIRECTION = """Longitudinal Story Engine / 跨 Horizon 长线推进（Story Program / Story Refresh / Outline 软原则，不新增 Agent 或每章 Gate）：**Canon 被保存不等于故事在推进。** 对已经形成读者牵引的长期 Rival、人物关系、主世界身份、旧收益、家族/故乡线、长期 Mystery 或具名旧债，只有继续产生新的可见事实，才算真正向前。每个新的 World Horizon 不要求把所有旧线拉回来，但至少应让 1—3 条当前最有牵引力的跨 Horizon 线程在本轮发生一次**可观察推进**：例如 Rival 学会新东西并改变主角选择；旧人物主动联系/索取/反噬；旧资产到账或引来争夺；旧谜团出现新的物证/访问条件；主世界势力因上轮公开表现重新报价、招揽、追查或敌视。只在 OPEN PROMISES 里原样保留、只在 Handoff 里再次列名、或只写“某人仍在成长”都不算推进。

长期线程必须服从已有 Authority：可以推进问题，不得替 AUTHOR OPEN 的谜团擅自给答案。Recurring Rival / 旧人物不需要机械每卷露脸；若其缺席本来合理，可以通过可靠消息、利益变化、别人采取的新行动或其留下的后果推进。目标是让读者感到“世界换了，但整本书仍在同一条越来越紧的因果链上”，而不是四部彼此只靠主角串联的中篇。"""
...
同一节还要维护 **2—4 条 Book-Level Longitudinal Spine**，服务约 60—120 章尺度的整本牵引，而不是只写 Power Stack。优先从已经成立的长期 Rival、主角人生/家族或故乡线、Meta Mystery、主世界身份/社会位置、反复可回访的重要关系/资产中选择。每条只写三件事：`当前仍在问什么 → 下一次读者可见的升级/变化应该是什么类型 → 哪个答案目前仍必须保持未知`。**不要在这里预写下一世界、未批准人物、具体未来章次或 Mystery 真相。** 当前 World Horizon 至少让其中一条真正推进一个新事实；其余可以继续蓄势。若现有 Story 连两条够强的跨 Horizon 线都没有，直接指出这是 long-form spine 缺口，不用世界列表、Open Promise 数量或 Power Stack 冒充“100章总主线”。
...
**当前 Horizon 不能把跨 Horizon 长线全部降成文末备忘。** 在阶段因果里自然选择 1—3 条最有牵引力的长期线程真正推进一次；推进必须产生新事实，而不是只提醒读者它仍存在。若这是多世界 instance，且本轮结尾返回主世界/Hub，优先把回归后的 Social Repricing / Rival 反制 / 旧资产兑现 / 家族关系 / 长期 Mystery 新物证中的至少一项写成下一阶段直接因果；除非已有更强的直接跨界因果让它延后。**新世界本身可以是主满足，但“因为下一个世界也很酷”不能成为整本书唯一的长篇推动力。**
