...
- **高价值 Orientation ≠ 低价值解释**：开篇先建立最低安全 / 社会 / 移动坐标；重要势力、地点、身份、资源或生活方式第一次真正影响选择时，允许 1—3 个短直接旁白回答“是什么 / 为什么重要 / 普通人或当前 POV 怎么看”，随后回到动作。World 提供事实，Outline 调度首次释放，Curator 只选已批准事实，Writer 只表达、不补隐藏原因；不做百科或每章说明配额。
