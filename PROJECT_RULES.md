...
- **Canon Retained ≠ Plot Advancing；跨 Horizon 长线必须轮流发生新事实**：Rival、旧人物、旧资产、家族/故乡线、长期 Mystery 或具名旧债被完整留在 `PERSISTENT CANON / OPEN PROMISES / Handoff` 只说明系统没有失忆，不算叙事推进。每个新 Horizon 不需要召回所有旧线，但 Story Program / Story Refresh 应让当前最有牵引力的 1—3 条长期线程中至少一条真实产生新事实，例如 Rival 换战术并改变选择、旧人物重新行动、旧收益到账/引来争夺、旧谜团出现新物证或主世界重新估价。多世界 instance 若返回主世界/Hub，回归不能长期退化成“确认能力 → 看下一门 → 再进副本”；旧获得应周期性改变主世界的力量、身份、敌人、关系、价格、入口或 Mystery。没有自然传播/接触因果时可以延后，但“下一个世界很酷”不能成为整本书唯一持续推动力。
- **Book-Level Longitudinal Spine 只固定跨 Horizon 的问题，不预写未来世界**：多世界长篇应在 `全书成长与核心幻想兑现脊柱` 中保有约 2—4 条能支撑 60—120 章的长线，例如长期 Rival、主角人生/家族线、Meta Mystery、主世界社会位置或可反复回访的重要关系/资产。每条只保存 `当前仍在问什么 → 下一次读者可见变化的类型 → 当前仍必须未知什么`；未来具体 World、人物、奖励、能力、章号和 Mystery 真相继续由后续 protagonist-blind World Expansion + fresh Re-Collision 决定。Spine 是整书牵引，不是 thread database、回访配额或提前写死的百章大纲。
