...
$helper=Join-Path $root 'temps\run_private_asymmetry_e2e.py'
$runner='C:\Users\jingx\AppData\Local\Temp\run-codex-acp.mjs'
$exp=Join-Path $root 'books\real-exp-private-prototype-asymmetry-novel-20260826-v2'
...
& $py $helper combine
Write-Output '=== FIVE CHAPTERS DONE ==='
