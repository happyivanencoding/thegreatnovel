...
TREATMENT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "speculative-next-director-v3"
OUT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "blind-speculative-next-director-v3"
...
def prepare() -> None:
    ...
    for chapter in CHAPTERS:
        ...
        speculative = clean((treatment_dir / "speculative_director_response.md").read_text(encoding="utf-8"))
        order = ["control", "speculative"]
        random.Random(20260829360 + chapter).shuffle(order)
