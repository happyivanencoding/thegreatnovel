...
SOURCE = BOOK / "runs"
TREATMENT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "parallel-precurator"
OUT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "blind-parallel-precurator"
...
def prepare() -> dict:
    ...
    for chapter in CHAPTERS:
        ...
        order = ["control", "parallel_precurator"]
        random.Random(2026082980 + chapter).shuffle(order)
        texts = {"control": control, "parallel_precurator": treatment}
