...
TREATMENT = BASE / "phase-j-patch-reviser-high"
OUT = BASE / "blind-judges-phasej-patch-high"
...
def prepare() -> dict:
    ...
    for chapter in CHAPTERS:
        ...
        options = {"control_high": control, "patch_high": patch}
        order = ["control_high", "patch_high"]
