...
SOURCE = BOOK / "runs"
TREATMENT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "ten-chapter-attention-kernel"
OUT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "blind-ten-chapter-attention-kernel"
...
def prepare() -> dict:
    ...
    for chapter in CHAPTERS:
        ...
        order = ["control", "attention_kernel"]
        random.Random(20260829780 + chapter).shuffle(order)
        texts = {"control": control, "attention_kernel": treatment}
