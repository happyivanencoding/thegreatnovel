...
SOURCE = BOOK / "runs"
TREATMENT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "parallel-commercial-spark"
OUT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "blind-parallel-commercial-spark"
...
def prepare() -> None:
    ...
    for chapter in CHAPTERS:
        ...
        order = ["control", "commercial_spark"]
        random.Random(20260829150 + chapter).shuffle(order)
        texts = {"control": control, "commercial_spark": treatment}
