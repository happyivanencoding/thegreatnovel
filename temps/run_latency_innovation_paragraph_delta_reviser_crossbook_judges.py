...
BOOK = ROOT / "books" / "real-exp-current-pipeline-authority-reviser-0010-20260828-v1"
SOURCE = BOOK / "runs"
TREATMENT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "paragraph-delta-reviser-crossbook"
OUT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "blind-paragraph-delta-reviser-crossbook"
...
def prepare() -> dict:
    ...
    for chapter in CHAPTERS:
        ...
        order = ["control", "paragraph_delta"]
        random.Random(20260829520 + chapter).shuffle(order)
        texts = {"control": control, "paragraph_delta": treatment}
