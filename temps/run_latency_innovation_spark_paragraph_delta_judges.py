...
SOURCE = BOOK / "runs"
TREATMENT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "spark-paragraph-delta"
OUT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "blind-spark-paragraph-delta"
...
def prepare() -> dict:
    ...
    for chapter in CHAPTERS:
        ...
        random.Random(20260829680 + chapter).shuffle(order)
