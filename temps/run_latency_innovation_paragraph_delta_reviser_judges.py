...
SOURCE = BOOK / "runs"
TREATMENT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "paragraph-delta-reviser"
OUT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "blind-paragraph-delta-reviser"
...
def prepare() -> dict:
    ...
    for chapter in CHAPTERS:
        ...
        random.Random(20260829120 + chapter).shuffle(order)
