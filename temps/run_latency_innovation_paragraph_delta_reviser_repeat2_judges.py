...
SOURCE = BOOK / "runs"
TREATMENT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "paragraph-delta-reviser-repeat2"
OUT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "blind-paragraph-delta-reviser-repeat2"
...
def prepare() -> dict:
    ...
    for chapter in CHAPTERS:
        ...
        random.Random(20260829440 + chapter).shuffle(order)
