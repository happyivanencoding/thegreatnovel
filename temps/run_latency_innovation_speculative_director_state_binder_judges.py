...
TREATMENT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "speculative-director-state-binder"
OUT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "blind-speculative-director-state-binder"
...
def prepare() -> None:
    ...
    for chapter in CHAPTERS:
        ...
        speculative = clean((treatment_dir / "bound_director_response.md").read_text(encoding="utf-8"))
        order = ["control", "speculative"]
        random.Random(20260829310 + chapter).shuffle(order)
