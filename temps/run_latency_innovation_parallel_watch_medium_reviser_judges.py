...
SOURCE = BOOK / "runs"
TREATMENT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "parallel-watch-medium-reviser"
OUT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "blind-parallel-watch-medium-reviser"
...
def prepare() -> dict:
    ...
    for chapter in CHAPTERS:
        ...
        order = ["control", "parallel_watch_medium"]
        random.Random(20260829110 + chapter).shuffle(order)
        texts = {"control": control, "parallel_watch_medium": treatment}
