...
SOURCE = BOOK / "runs"
TREATMENT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "dual-medium-curator"
OUT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "blind-dual-medium-curator"
...
def prepare() -> dict:
    ...
    for chapter in CHAPTERS:
        ...
        order = ["control", "dual_medium_curator"]
        random.Random(20260829110 + chapter).shuffle(order)
        texts = {"control": control, "dual_medium_curator": treatment}
