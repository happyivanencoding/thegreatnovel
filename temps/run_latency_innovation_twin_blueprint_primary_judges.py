...
SOURCE = BOOK / "runs"
TREATMENT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "twin-blueprint-primary"
OUT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "blind-twin-blueprint-primary"
...
def prepare() -> dict:
    ...
    for chapter in CHAPTERS:
        ...
        order = ["control", "twin_blueprint_primary"]
        random.Random(20260829100 + chapter).shuffle(order)
        texts = {"control": control, "twin_blueprint_primary": treatment}
