...
SOURCE = BOOK / "runs"
TREATMENT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "authority-blueprint-primary"
OUT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "blind-authority-blueprint-primary"
...
def prepare() -> dict:
    ...
    for chapter in CHAPTERS:
        ...
        order = ["control", "authority_blueprint_primary"]
        random.Random(2026082990 + chapter).shuffle(order)
        texts = {"control": control, "authority_blueprint_primary": treatment}
