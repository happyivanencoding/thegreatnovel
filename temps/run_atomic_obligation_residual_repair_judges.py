...
SOURCE = BOOK / "runs"
TREATMENT = ROOT / "books" / "real-exp-atomic-chapter-obligations-20260829-v1" / "phase-c3-residual-repair"
OUT = ROOT / "books" / "real-exp-atomic-chapter-obligations-20260829-v1" / "phase-d3-blind-residual-repair"
...
def prepare() -> dict:
    ...
    for chapter in CHAPTERS:
        ...
        random.Random(202608291250 + chapter).shuffle(order)
