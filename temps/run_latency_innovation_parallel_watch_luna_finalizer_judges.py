...
SOURCE = BOOK / "runs"
TREATMENT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "parallel-watch-luna-finalizer"
OUT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "blind-parallel-watch-luna-finalizer"
...
def prepare() -> dict:
    ...
    for chapter in CHAPTERS:
        ...
        order = ["control", "parallel_watch_luna"]
        random.Random(2026082999 + chapter).shuffle(order)
        texts = {"control": control, "parallel_watch_luna": treatment}
