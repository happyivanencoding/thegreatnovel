...
TREATMENT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "speculative-next-director-canonless-downstream"
OUT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "blind-speculative-next-director-canonless-downstream"
...
def prepare() -> dict:
    ...
    for chapter in CHAPTERS:
        ...
        order = ["control", "canonless_downstream"]
        random.Random(20260829840 + chapter).shuffle(order)
        texts = {"control": control, "canonless_downstream": candidate}
