...
SOURCE = BOOK / "runs"
TREATMENT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "parallel-authority-watch"
OUT = ROOT / "books" / "real-exp-chapter-latency-innovation-20260829-v1" / "blind-parallel-authority-watch"
...
def prepare() -> dict:
    ...
    for chapter in CHAPTERS:
        ...
        order = ["control", "parallel_watch"]
        random.Random(2026082970 + chapter).shuffle(order)
        texts = {"control": control, "parallel_watch": treatment}
