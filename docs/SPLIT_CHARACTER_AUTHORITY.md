...
行为签名 = **稳定选择偏向 + 具体实现随现场变化**。具体关系只有在“因为是这个人”而真实改变选择时才成立；同等有用的人不能自动替代。
...
高价值获得与纵向复利是全书原则，不是阶段字段税。Power Asymmetry 要长期形成优势栈：旧优势保留，新优势通过故事加入，并出现单项做不到的复合玩法；不要求每阶段新增。显露新优势、新层级或意外复合时，现场已有懂行者/对手/同伴的惊讶与比较本身可以完成爽感；只有重新估价会改变后续行动或关系时才进一步写态度转变。反制只能从碰撞后的学习产生，敌人不能只为机械克制主角而出生。
