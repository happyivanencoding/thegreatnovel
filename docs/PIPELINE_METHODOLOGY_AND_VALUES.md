...
- **主角最强欲望分成两层**：眼前非做不可的具体目标，以及即使核心优势暂时不能用仍会驱动他继续往前的**人生牵引**；人生牵引不能只是“让能力更强 / 找更多适合能力的对象 / 把玩法做大”；
...
- 故事局面怎样改变：可以换地图、力量升级，也可以主要是关系翻转、归乡、战争、失去/重逢、宿敌或生活处境改变；不强制每个阶段世界扩张；
...
- `下一阶段为什么自然发生`：替代“更大机会”，不要求下一阶段更大，只要求由人物、承诺、关系、未死敌人、得到/失去的东西或世界事件自然触发；
