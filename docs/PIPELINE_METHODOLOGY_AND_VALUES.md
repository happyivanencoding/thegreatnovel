...
World Vision 应让能力“更有世界感”，而不是把能力变成一个更完整的系统产品。健康的 World Vision 还应给下游足够的**比较尺**：读者什么时候能立刻知道“这个人比主角强很多”“这个身份真的打开了新东西”“这件东西为什么值得争”“金手指为什么不会遇到高手就自动崩坏世界尺度”。尺子可以很简单，但不能等到 Director 才临时发明。
...
- 关系重构；
- 世界和力量怎样自然扩大；
- 核心优势的**选择空间与反制**：如果乐趣来自选谁、选什么、何时使用、保留或舍弃，就让这种判断成为长期玩法；对手怎样隐藏、诱导、封锁、改变条件或逼主角提前消耗优势；不强制统一槽位/冷却模板；
...
- **World Model Release**：开书前三章在相关冲突或爽点需要之前，通过事件让读者自然获得 World Vision 已经定义的强弱、身份、价值与能力边界；只释放当前故事需要的尺度，不把正文写成设定说明；
