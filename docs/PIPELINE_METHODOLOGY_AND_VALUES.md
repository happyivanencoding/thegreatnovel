...
- **World Independence ≠ Narrative Equal Weight**：世界独立只要求没有主角仍有别的故事在发生，不要求税、土地、治理、迁徙、制度和每个利益方都获得同等篇幅；核心幻想、主角欲望人格和当前最馋人的故事对象决定前景权重。
...
- **主角欲望人格与行为签名**：除了“想要什么”，还提前固定“会怎么要”——面对机会、强敌、羞辱、自己人出事时有哪些长期可识别的倾向，让不同主角在同一题面下会做出不同选择；
- 非对称优势与第一次标志性奇观；
...
- **没有主角时，谁正在追什么，哪里正在发生什么**：优先建立具体人物/群体正在追求、挑战、寻找或逃避的对象，以及正在开启的遗迹、竞赛、战争、奇观、怪物、传承和机会；普通生活、经济、制度和资源流只写到足以解释这些故事为什么发生，不再用完整政治经济利益网络证明“世界独立”；
...
- **主角行为连续性**：阶段选择必须继承 Seed 的欲望人格与行为签名；Contestable Choice 没有标准答案时，让人物性格决定取舍，不由系统默认的理性折中方案接管；
...
- 关系重构，但 Character Autonomy 不得机械翻译成“拒绝被收编、只按自身利益合作、双方重新谈条件”；追随、爱慕、拜师、效忠、背叛、屈服和死敌同样可以是有自主欲望的人物关系；
...
2. **谁也想要，或谁阻止他？**
3. **主角怎样主动行动，为什么这是“这个人”而不是任何理性主角都会做的选择？核心优势怎样创造超额结果？**
