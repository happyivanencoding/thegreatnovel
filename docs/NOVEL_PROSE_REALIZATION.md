...
**Reader-Facing Scene Ecology**：复杂多方场景先建立少量 Stable Scene Geography，再移动人物。第一次进入高负荷动作前，用一两句立住 3—5 个会跨章复用的空间锚点及关系；后续尽量沿用同一组名词，新行动点先说明它相对旧锚点的位置。动作推进两三轮、人物换位、通路开闭或目标变化后，允许用 1—4 句非常直接地重报“谁在哪 / 哪条路开着 / 谁守什么 / 还差哪个点 / 主角现在要去哪”——`Action Advance ≠ Situation Memory`，这是更新读者 working memory，不是重复解释。有限 POV 在多方局面中允许 `观察 → 判断/猜测 → 必要时发现判断不全 → 决定`，让读者借主角脑子理解为什么现在这么做，不要求主角全知。

**Living Power Ecology / Active Interior Continuity**：当前 Authority 已给重要人物公开精确位置/阶段且它解释现场分量时，在第一次自然比较、出手、让路、忌惮、封路或准入变化时直接用一次；明显高阶人物在场却不介入时，若 Plan 已给目标/职责/空间/利益边界，用最短一句或行为说明其边界，不让强者像作者忘记了。重要配角当前真正起作用的 reader-safe 私人压力、旧关系或不愿承认的判断，也至少影响一次对白长度/措辞、停顿、注意力、误判、拒绝/让步或选择；有限 POV 不直接偷写别人内心，也不把完整 Biography 倾倒出来。对白长短随人物和压力变化：秒级危机可以短，非秒级现场不把所有角色统一压成“一句话完成一个剧情功能”。
...
**按完整意思组织叙述与对白**：已知观察直接陈述，没有实际误认就不先否定再揭答案；普通信息不整理成整齐排比、重复句首或人为的逐句揭晓。一人没有被现场打断时把一个意思说完，次要应答可由叙述带过；多人交谈、插话或动作后恢复对白时，用姓名、称呼或与人物绑定的动作说明归属。同一人的话及接续动作通常连成自然段，不为章末钩子机械拆句，也不为标归属逐句加点头、抬眼。取消一章一次的修辞配额，不新增禁词扫描、style score或Reviewer。判断读感前先读经典原文中相应场景，记录实际书名、章节和定位；原文只作参照，用户反馈参与最终判断。
