...
处理 handoff_id=handoff_687308619171257b396d32c7。

运行 deterministic workflow start；成功后信任其 RUNNING contract。
Python 已冻结 executor_skill=bootstrap-original-novel；调用 $bootstrap-original-novel Skill，严格执行该 Skill 的 requested_stage=CORE_INNOVATION_PROPOSAL。
...
```json
{
  ...
  "effective_query": {
    "creative_problem": "CORE_INNOVATION_PROPOSAL：围绕作者 premise 与已确认阅读体验寻找可迁移的故事机制，只作为 Core/Foundation/Candidate 的参考候选。",
    "creative_problem_tags": [],
    "max_cards": 6,
    "narrative_drives": [
      "SURVIVAL_RESOURCE",
  ...
  "snapshot_hash": "625205d63fdb8680fa3b681f380bb4f3e43ade4b5a3a137fe158e7e9a77cba1b",
  "snapshot_id": "reference-context_56287750652bee6f35ed3f40",
  "status": "ENABLED",
